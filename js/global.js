/*
 Created on : Apr 24, 2015, 11:15:15 AM
 Author     : rmoiniaraghi
 */
...
function grayOut(vis, options) {
    ...
    if (!dark) {
        ...
        tnode.innerHTML = '<br /><br /><br /><br /><br /><br /><br /><br /><center><FONT SIZE="20" COLOR="ffffff">Processing request...</FONT></center>';
...
function setLoginFieldFocus() {
    ...
    var daField2Focus = document.getElementById("password");

    if (daField2Focus != null) {

        var daUsernameField = document.getElementById("username");
